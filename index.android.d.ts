...
declare module 'react-native-google-fit' {
  export interface GoogleFit {
     ...
     * @param {Object} options  getBodyFatSamples accepts an options object containing startDate: ISO8601Timestamp and endDate: ISO8601Timestamp.
     */
    getBodyFatSamples: (
      options: StartAndEndDate & Partial<{ ascending: boolean } & BucketOptions>
  ...
  export type BodyFatResponse = WeightResponse
